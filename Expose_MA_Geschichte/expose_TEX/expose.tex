...
\subsubsection{Beispiele formaler, digitaler Methoden}

VASOLD hat in seiner Arbeit in den 1990er Jahren mit der computergestützten Verarbeitung der Itinerar\footnote{Als Itinerar versteht man nicht nur Reiseberichte, sondern auch die Methode der Rekonstruktion der getätigten Wege einer Person oder Gruppe.} des Erzbischofs Konrad IV. von Salzburg die Möglichkeiten und den Mehrwert formaler Methoden in den Geschichtswissenschaften gezeigt. Er hat auf Basis eines mittelgroßen Quellenbestandes aus Urkunden oder historiographischen Belege, die Reisetätigkeiten eines Erzbischofes aus dem Mittelalter rekonstuiert, in dem er ein Modell zur Beschreibung seiner Belege entwickelte und diese Daten im quellenorientierten Datenbanksystem Kleio\footnote{Was ist kleio} formal strukturierte. Als Vorteil dieser Herangehensweise führt VASOLD an, das durch die Ein- und Ausblendung bestimmter Strukturen und Quellen, sich ein stabiles Bild des Weges einer Person skizzieren lässt.
\\
Unter Verwendung der ''dynamisch integierten computergestützen Edition'' hat PERSTLING das Marchfutterurbar aus den Jahren 1412 vis 1426 erschlossen und der Forschungscommunitie über das Web zur Verfügung gestellt. Der Fokus dieser Arbeit liegt auf der Beschreibung multipler Perspektiven, die die Quelle mit sich bringt.
\\
Von BURKGART et. all wurde ein Urfehdebuch aus de, 16. Jahrhundert digital ediert und die Information über Täter, Opfer und ihre Verfahren modelliert und in Form einer digitalen Edition mit Such- und Selektionsfunktionalitäten umgesetzt. 
