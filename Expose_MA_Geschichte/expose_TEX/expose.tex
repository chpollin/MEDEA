...
\end{itemize}
In folgender Abbildung ist die dritte Seite des Rechnungsbuches aus Stagville.\footnote{Stagville Accounts, From the Page, \protect\url{https://fromthepage.com/agbedavies/stagville-accounts/00133-sv0061/display/7884}, 08.10.2019.} Der erste Eintrag beschreibt den Kauf eines Schumessers zum Preis von 1 Schilling und 6 Pence. Im ''\textit{Slave-Ledger}'' verkauft Cameron, aber ein Schuhmesser für 2 Schilling. Ob der Änderung des Preises durch den zeitlichen Unterscheid gegeben ist, oder eben durch den sozialen Status der Kunden, ist eine geschichtswissenschaftliche Fragestellung.\footcite[][]{brumfield2019blog}
\begin{figure}[H]
  \centering
