...
\\
\\
DEMANDT gibt ausführliche Definitionen zu den zentralen und grundlegenden Bergriffen. Neben dem Mythos, der in erzählerischer Form Vergangenes weitergibt, war die Chronistik eine früher Form der verschriftlichten, geschichtlichen Erinnerung. Die Historiographie geht noch einen Schritt weiter und versucht Ereigniszusammenhänge darzustellen. Im 16. Jahhundert entwickelt sich der Begriff Geschichte, der anfangs nur für den Gegenstandsbereich der Historie, der Erzählung der 'wahren', oft vermischt mit einer fiktionalen, Vergangenheit, verwendet wurde.\footcite[][S.57-58]{schulz2010neuere} Das modernen Verständnis des Wortes Geschichte umfasst sowohl die ''Gesamtheit von realen Geschehnissen'', als auch den Bericht darüber. Zentral in der modernen Geschichtswissenschaft, die wissenschaftliche Erforschung der Vergangenheit, ist die Auseinandersetzung mit historischen Quellen, die mittels kritischer Methode untersucht werden. In diesem Prozess müssen die angewandten Methoden, Ideen und Ergebnisse diskutierbar und nachprüfbar sein.\footcite[][S.13-32]{demand2011philosophie} Jeder soll in der Lage sein feststellen zu können, ob eine Interpretation eines historischen Sachverhalts auch so in der angeführten Quelle nachvollziehabr ist.
\\
Ein weiterer zentraler Aspekt ist die Hermeneutik. Dabei handelt es sich um eine Theorie der Interpretation und des Verstehens von Texten. DILTHEY unterscheidet zwischen ''erklären'' und ''verstehen''. Wo die die Naturwissenschaften erkennbaren Gegebenheiten der Welt von außen versuchen zu erklären, ist es Aufgabe der Geisteswissenschaften, die Welt von innen zu verstehen. \footcite[][S.19-30]{schulz2010neuere}  Bei Gadamer erhält der Begriff eine weitere Bedeutung. Nicht nur unser Wissen über Texte und geistige Produkte, sondern alles Wissen auf beruht auf einem Verstehen, das in einer Auslegung unseres Wissens erläutert wird.\footnote{STANGL, Werner: Geschichte der Hermeneutik, \protect\url{https://arbeitsblaetter.stangl-taller.at/ERZIEHUNGSWISSENSCHAFTGEIST/HermeneutikHistorie.shtml}, 01.06.2019.}
Verstehen in diesem Sinne ist zirkelförmig. Jemand tritt mit einem gewissen Vorwissen an eine Fragestellung heran. Es werden in der Auseinandersetzung mit der Materie Erfahrungen gesammelt und ein tieferes Verständnis der Thematik erarbeitet. Mit diesem gefestigteren Verständnis kann man sich in diesem hermeneutischen Zirkel wieder weiter bewegen und in einem, iterativen Prozess ein besseres Bild des Themas erlangen. Eine Problemstellung muss zuerst gefunden, erkannt und verstanden werden. Im Zusammenspiel mit empirischer Methoden ist die Hermeneutik für die Hypothesenbildung und für die Interpretation der Ergebnisse von großer Bedeutung. Bei der empirischen Überprüfung von Sachverhalten spielt die Hermeneutik eine wesentliche Rolle bei der Operationalisierung (qualitative Aussagen werden quantitfizierbar gemacht), aber auch die Interpretation von empirischen Resultaten ist ein hermeneutischer Vorgang.\footnote{STANGL, Werner: Der hermeneutische Zirkel, \protect\url{https://arbeitsblaetter.stangl-taller.at/ERZIEHUNGSWISSENSCHAFTGEIST/HermeneutikZirkel.shtml}, 01.06.2019.}
\\
\\
