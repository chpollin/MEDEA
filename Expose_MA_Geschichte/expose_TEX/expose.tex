...
Die Wheaton Family Papers umfassen mehrere Bücher und andere Dokumente im Zeitraum von 1828 bis 1859, die die finanziellen Geschäfte von \textit{Laban Morey Wheaton}, einem Geschäftsbesitzer aus Norton, Massachusetts in den Vereinigten Staaten von Amerika, dokumentieren. Das Wheaton College Massachusetts stellt diese Dokumente in ihrem digitalen Repositorium online zur Verfügung.\footnote{Wheaton Family Papers, \url{https://digitalrepository.wheatoncollege.edu/handle/11040/7928}, 19.05.2019.} 
\\
In einem Projekt hat TOMASEK mit Studierenden gemeinsam das sogenannte \textit{Daybook}, das den Verkauf und Kauf von Gütern des täglichen Lebens listet und ein \textit{Ledger}, ein Hauptbuch, das die Finanzflüsse an einer zentralen Stelle zusammenfasst transkribiert und mit der TEI ausgezeichnet.\footcite[][]{tomasek2013encoding}
\\
Abbildung \ref{fig:wheaton} zeigt Seite 100 und 101 des Daybooks. Die linke Seite beginnt mit einer Überschrift ''Norton Tuesday Sept 6 1831''. Die ersten Einträge in dieser tabellarische Struktur beziehen sich nun auf den 6. September des Jahres 1831. An diesem Tag hat "Wheaton Wheeler" einen halben ''Burell Corn'', also ein halbes Büschel Mais, für den Geldbetrag von 50 Cent erworben. Die mittlere Spalte nennt die zweite person in der Transaktion repräsentiert die wesentliche Information und lsitet für jede Zeile eine Transaktion bzw. andere Information zu dieser person an. IN den 4 Spalten rechts, werden die Geldbeträge gelistet: in der ersten Spalte die Dollar und in der zweiten die Cent. Die Zahl ''393' an der der ersten Spalte  referenziert auf das Hauptbuch und verweist auf eine Seite wo Information zum Satus der Transaktion vorzufinden sind. Wie man auf der zweiten Seite sieht, kann in dieser ersten Spalte neben einer zahl auch das Wort ''Bill'', ''Paid'' oder ''Settled'' stehen. Diese Wörter beschreiben, dass eine Transaktion ''auf Rechnung''. ''bezahlt'' oder ''beglichen'' wurde.
\\
IM Fluss des Textes lassen sich zwischen den Einträgen entweder einfache Zahlen ''12'', ''24'' eben ein neues Tagesdatum an, eben den 12. oder 24. September bis mit ''Oct 8th 1831'' alle nun folgenden Einträge bereits zum Oktober gehören.
\\
Neben den Akteuren in den Ein trägen lässt sich meistens ein D, selten ein C vorfinden. Das ''Dr'' steht für ''Debitor'', das ''Cr'' für ''Creditor'' und sagt aus, das eine Transaktion auf die HABEN bzw. die SOLL-Seite eines Kontos gebucht wird.
\begin{figure}
\centering
...
\\
\\
Dieses Projekt verfolgt einen TEI/XML-Ansatz.
\\
